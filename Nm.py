...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]Notmeowl YT [00FF00]!!
"""
                    ...
                    try:
                        ...
                        if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                            try:
                                ...
                                message = f'[B][C]{get_random_color()}\n- WeLComE To Emote Bot ! \n\n{get_random_color()}- Commands : !e {xMsGFixinG('player_uid')} {xMsGFixinG('909000001')}\n\n[00FF00]Dev : @{xMsGFixinG('NoTmeowl')}'
                                P = await SEndMsG(0 , message , OwNer_UiD , OwNer_UiD , key , iv)
                                await SEndPacKeT(whisper_writer , online_writer , 'ChaT' , P)
                            except:
                                pass
...
async def MaiiiinE():
    Uid , Pw = '4270310769','4137A3054A7054E7F79C7C785634A7E7FF603CC1D59DC667775DC6B4748D826D'
    ...
    print(f" - Subscribe > Notmeowl | BRO ! (:")    
